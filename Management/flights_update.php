...
<div class="col-xs-6">
	<h4>Destination</h4>
	<input type="text" name="destination" class="form-control" placeholder="Enter destination" value="<?php echo($destination);?>">
</div>
...
<div class="col-xs-6">
	<h4>Origin Code</h4>
<input type="text" name="origin_code" class="form-control" placeholder="Enter origin code" value="<?php echo($origin_code);?>">
</div>

<div class="col-xs-6">
	<h4>Destination Code</h4>
<input type="text" name="destination_code" class="form-control" placeholder="Enter destination code" value="<?php echo($destination_code);?>">
</div>
